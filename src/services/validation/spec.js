...
test("validateAndFormatPhoneNumber allows valid numbers, returns E164", async (t) => {
  t.equal(validateAndFormatPhoneNumber("+14155809925"), "+14155809925");

  t.equal(validateAndFormatPhoneNumber("+44 0118 978 0006"), "+441189780006");

  t.equal(validateAndFormatPhoneNumber("+1 (978) 255 - 0031"), "+19782550031");

  t.equal(validateAndFormatPhoneNumber("415 580 9925"), "+14155809925");
...
test("validateAndFormatPhoneNumber disallows invalid numbers", async (t) => {
  ...
  t.throws(() => validateAndFormatPhoneNumber("+1 415"), InvalidDataError);
