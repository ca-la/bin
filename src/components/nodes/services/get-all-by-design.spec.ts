  ...
  t.deepEqual(result.assets, [
    ...
    },
    {
      ...
      assetLinks: {
        ...
        fileType: "jpeg",
        thumbnailLink: `https://imgix-foo.com/${asset2.id}?fm=jpg&fit=fill&h=160&w=208`,
        thumbnail2xLink: `https://imgix-foo.com/${asset2.id}?fm=jpg&fit=fill&h=160&w=208&dpr=2`,
