...
test(
  'GET /component-relationships/?componentId returns a list of relationships',
  async (t: tape.Test) => {
    ...
    t.deepEqual(
      getBody,
      [
        { ...relationshipOne, createdAt: relationshipOne.createdAt.toISOString() },
        { ...relationshipTwo, createdAt: relationshipTwo.createdAt.toISOString() }
      ],
