...
test(
  ...
  async (t: Test) => {
    ...
    t.equal(notificationMentionStub.notCalled, true, 'Mentions notification not created');
    ...
    t.equal(notificationMentionStub.called, true, 'Mentions notification was created');
    t.equal(notificationStub.calledOnce, true, 'Comment notification not created');
