...
import submissionCommentsRoutes from "./components/submission-comments/routes";
...
router.use("/design-quotes", designQuoteRoutes);
...
router.use("/submission-comments", submissionCommentsRoutes);
