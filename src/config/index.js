...
const config = {
  ...
  AWS_API_WORKER_SQS_REGION: process.env.AWS_API_WORKER_SQS_REGION,
  AWS_API_WORKER_SQS_URL: process.env.AWS_API_WORKER_SQS_URL,
  ...
  IMGIX_PURGE_API_KEY: process.env.IMGIX_PURGE_API_KEY,
