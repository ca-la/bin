...
export const partialDataAdapter = new DataAdapter<Partial<CollectionRow>, Partial<Collection>>();

export function isCollectionRow(row: object):
  row is CollectionRow {
...
export function isPartialCollection(candidate: object): candidate is Partial<Collection> {
